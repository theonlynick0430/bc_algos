...
python scripts/train.py --config config/bct_isaac_gym.json --dataset /nfs/turbo/coe-jjparkcv/datasets/isaac-gym-pick-place/simple/preprocessed/dataset_v13_diff --output outputs/
wait