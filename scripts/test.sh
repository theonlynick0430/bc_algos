...
python scripts/test.py --config config/bc_transformer.json --dataset /home/niksrid/bc_algos/datasets/dataset_v16_diff --weights /home/niksrid/bc_algos/outputs/bct_isaac_var2/weights/model_49.pth --output /home/niksrid/bc_algos/output