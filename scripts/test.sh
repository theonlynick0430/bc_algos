...
python scripts/test.py --config config/bc_transformer.json --dataset /nfs/turbo/coe-jjparkcv/niksrid/data/bc_robomimic/preprocessed/square_ph.hdf5 --weights outputs/bc_transformer/weights/model.pth --output outputs/
wait